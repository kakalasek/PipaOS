/* Data types and setup for the interrupt descriptor table/IDT */
...
typedef struct 
{
    ...
    uint16_t isr_address_high;  // Upper 16bits for isr address
...
void set_idt_descriptor_32(uint8_t entry_number, void *isr, uint8_t flags)
{
    ...
    descriptor->kernel_cs           =   0x1000;                     // Kernel code segment containing this isr
